...
- ✅ Direct bool return instead of `.OpenedSuccessfully` / `.ClosedSuccessfully`
- ✅ Clean `[]BookInfo` DTO instead of `[]*pb.MqlBookInfo`
- ✅ Clear method names (Subscribe/Unsubscribe)
...
- [Market Depth Information](../API_Reference/MT5Account.md) - low-level DOM operations
...
- ✅ Get bool directly (success/fail)
- ✅ Clean `[]BookInfo` DTO instead of protobuf
- ✅ Clear names (Subscribe/Get/Unsubscribe)
- ✅ Code reads like standard Go

**Typical workflow:**

```go
// Subscribe → Get → Process → Unsubscribe
